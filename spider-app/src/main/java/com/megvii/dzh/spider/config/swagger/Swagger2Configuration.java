package com.megvii.dzh.spider.config.swagger;
...
public class Swagger2Configuration {
   ...
   * Swagger ui 页面显示信息
   */
  private final String SWAGGER2_API_TITLE = "爬虫控制器"; // 标题
  private final String SWAGGER2_API_BASEPACKAGE = "com.megvii";
  private final String SWAGGER2_API_DESCRIPTION = "";
  private final String SWAGGER2_API_CONTACT = "超允.chen";
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder().title(SWAGGER2_API_TITLE).description(SWAGGER2_API_DESCRIPTION)
      .contact(SWAGGER2_API_CONTACT).version(SWAGGER2_API_VERSION).build();
  }
}
