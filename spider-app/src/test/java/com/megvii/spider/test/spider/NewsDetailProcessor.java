...
@Slf4j
public class NewsDetailProcessor implements PageProcessor {
  ...
  public void process(Page page) {
    ...
    String title = html.xpath("//*[@id=\"epContentLeft\"]/h1/text()").toString().trim();
    log.info(title);
  }


  public static void main(String[] args) {
    Spider.create(new NewsDetailProcessor())//
        .addPipeline(new ConsolePipeline())//添加管道
        .addUrl("http://tech.163.com/18/1128/16/E1NAP0OO00097U7R.html")//爬取的初始URL
        .thread(1)//爬取线程
        .run();
  }
}
